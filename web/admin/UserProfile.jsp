                        ...
                        <div class="tab-pane fade show active" id="account" role="tabpanel">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form id="profileForm" method="post" action="${pageContext.request.contextPath}/admin/UserProfile">
                                        <div class="row">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <c:choose>
                                                <c:when test="${sessionScope.user.role.roleId == 1}">
                                                    <select id="inputWarehouse" name="warehouse_id" class="form-select editable" disabled>
                                                        <option value="">None</option>
                                                        <c:forEach var="wh" items="${warehouses}">
                                                            <option value="${wh.warehouseId}" ${wh.warehouseId == user.warehouseId ? 'selected' : ''}>${wh.warehouseName}</option>
                                                        </c:forEach>
                                                    </select>
                                                </c:when>
                                                <c:otherwise>
