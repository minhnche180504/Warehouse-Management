        ...
        <div class="wrapper">
            ...
            <main class="content">                    
                <div class="container-fluid p-0">
                        <div class="row mb-3">
                            <div class="col-6">
                                <h1 class="h2 mb-3 fw-bold text-primary">Product Management</h1>
                            </div>
                            <div class="col-6 text-end">
                                <a href="create-product" class="btn btn-primary">
                                    <i class="align-middle me-1" data-feather="plus"></i> Add New Product
                                </a>
                            </div>
                        </div>
                          <% 
                                ...
                                <div class="card shadow-sm">
                                    <div class="card-header pb-0">
                                        ...
                                        <div class="row mt-3">                                            <div class="col-md-6">
                                                <form action="/admin/product-list.jsp" method="get" class="d-flex">
                                            ...
                                            <table class="table table-striped table-hover">                                                <thead>
                                                ...
                                                <tbody>
                                                    <%                                                        try {
                                                            ...
                                                            // Check if we have attribute filters
                                                    ...
                                                    %>                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            if (product.getAttributes() != null && !product.getAttributes().isEmpty()) {
                                                                ...
                                                                // Display only the key attributes (CPU, RAM, Storage)
                                                                String[] keySpecs = {ProductAttributeHelper.ATTR_CPU, 
                                                                                    ProductAttributeHelper.ATTR_RAM, 
                                                                                    ProductAttributeHelper.ATTR_STORAGE};
                                                        ...
                                                        <td class="text-end">
                                                            <a href="product-detail.jsp?id=<%= product.getProductId() %>" class="btn btn-sm btn-info">
                                                                <i data-feather="eye"></i>
                                                            </a>
                                                            <a href="edit-product?id=<%= product.getProductId() %>" class="btn btn-sm btn-primary">
                                                                <i data-feather="edit-2"></i>
                                                            </a>
                                                            <a href="#" onclick="confirmDelete(<%= product.getProductId() %>)" class="btn btn-sm btn-danger">
