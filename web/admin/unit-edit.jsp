...
<html lang="en">
    <head>
        ...
        <title>Edit Unit | Warehouse System</title>
            ...
            <div class="main">
                ...
                <main class="content">                    
                    <div class="container-fluid p-0">
                        <h1 class="h2 mb-3 fw-bold text-primary">Edit Unit</h1>
                        
                        <%
                            // Get unit object from request or use empty unit if not available
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-8">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="${pageContext.request.contextPath}/admin/edit-unit" method="post">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="unitName" required
                                                       ...
                                                       value="<%= unit.getUnitName() != null ? unit.getUnitName() : "" %>">
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="unitCode" required
                                                       ...
                                                       value="<%= unit.getUnitCode() != null ? unit.getUnitCode() : "" %>"
                                                       maxlength="10">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Description</label>
                                                <textarea class="form-control" name="description" rows="3"
                                                          placeholder="Enter unit description"><%= unit.getDescription() != null ? unit.getDescription() : "" %></textarea>
                                            </div>
                                            <div class="mb-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox"
                                                           name="isActive" id="isActive"
                                                           <%= unit.isIsActive() ? "checked" : "" %>>
