                            ...
                            <div class="tab-pane fade show active" id="account" role="tabpanel">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form id="profileForm" method="post" action="${pageContext.request.contextPath}/manager/UserProfile">
                                            <div class="row">
                                            ...
                                            <div class="mt-3 d-flex gap-2">
                                                <a href="${pageContext.request.contextPath}/manager/manager-dashboard" class="btn btn-secondary">Back</a>
