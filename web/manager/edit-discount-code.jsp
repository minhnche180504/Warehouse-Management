...
<head>
    ...
    <title>Edit Discount Code | Warehouse System</title>
...
<body data-theme="default" data-layout="fluid" data-sidebar-position="left" data-sidebar-layout="default">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div>
                            <h1 class="h2 fw-bold text-primary">Edit Discount Code</h1>
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-3">
                                    <div class="text-center">
                                        <h4 class="mb-1">${discountCode.usedCount}</h4>
                                ...
                                <div class="col-md-3">
                                    <div class="text-center">
                                        <h4 class="mb-1">
                                            <c:choose>
                                                <c:when test="${discountCode.usageLimit != null}">
                                ...
                                <div class="col-md-3">
                                    <div class="text-center">
                                        <h4 class="mb-1">
                                            <c:choose>
                                                <c:when test="${discountCode.active}">
                                ...
                                <div class="col-md-3">
                                    <div class="text-center">
                                        <h4 class="mb-1">
                                            <fmt:formatDate value="${discountCode.createdAt}" pattern="dd/MM/yyyy"/>
                                        </h4>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="post" action="edit-discount-code" id="editForm">
                                        <input type="hidden" name="id" value="${discountCode.discountId}">
                                        
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label for="code" class="form-label">Discount Code</label>
                                                <input type="text" class="form-control code-readonly" id="code" 
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name" 
                                                       value="${discountCode.name}" maxlength="100" required 
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="description" name="description" 
                                                      rows="3" maxlength="500" placeholder="Optional description for this discount...">${discountCode.description}</textarea>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="form-select" id="discountType" name="discountType" required onchange="updateDiscountType()">
                                                    ...
                                                    <option value="PERCENTAGE" ${discountCode.discountType == 'PERCENTAGE' ? 'selected' : ''}>Percentage (%)</option>
                                                    <option value="FIXED_AMOUNT" ${discountCode.discountType == 'FIXED_AMOUNT' ? 'selected' : ''}>Fixed Amount (₫)</option>
                                                </select>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="discountValue" name="discountValue" 
                                                           value="${discountCode.discountValue}" min="0" step="0.01" required onchange="updatePreview()">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="minOrderAmount" name="minOrderAmount" 
                                                           value="${discountCode.minOrderAmount > 0 ? discountCode.minOrderAmount : ''}" 
                                                           min="0" step="1000" onchange="updatePreview()">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="maxDiscountAmount" name="maxDiscountAmount" 
                                                           value="${discountCode.maxDiscountAmount != null ? discountCode.maxDiscountAmount : ''}" 
                                                           min="0" step="1000" onchange="updatePreview()">
                                                    <span class="input-group-text">₫</span>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="date" class="form-control" id="startDate" name="startDate" 
                                                       value="<fmt:formatDate value='${discountCode.startDate}' pattern='yyyy-MM-dd'/>" 
                                                       required onchange="updatePreview()">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="endDate" class="form-label">End Date <span class="required">*</span></label>
                                                <input type="date" class="form-control" id="endDate" name="endDate" 
                                                       value="<fmt:formatDate value='${discountCode.endDate}' pattern='yyyy-MM-dd'/>" 
                                                       required onchange="updatePreview()">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="number" class="form-control" id="usageLimit" name="usageLimit" 
                                                       value="${discountCode.usageLimit != null ? discountCode.usageLimit : ''}" 
                                                       min="${discountCode.usedCount}" onchange="updatePreview()">
                                                <div class="form-text">
                                                    Leave empty for unlimited. Minimum: ${discountCode.usedCount} (already used)
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="isActive" class="form-label">Status</label>
                                                <select class="form-select" id="isActive" name="isActive">
                                                    <option value="true" ${discountCode.active ? 'selected' : ''}>Active</option>
                                                    <option value="false" ${!discountCode.active ? 'selected' : ''}>Inactive</option>
                                                </select>
                                                <div class="form-text">Inactive codes cannot be used</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                            ...
                                            <button type="submit" class="btn btn-primary">
                                                <i class="fas fa-save me-1"></i>Update Discount Code
                                            </button>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="preview-card">
                                ...
                                <div id="previewContent">
                                    <div class="fw-bold text-primary mb-2" id="previewCode">${discountCode.code}</div>
                                    <div class="fw-medium mb-2" id="previewName">${discountCode.name}</div>
                                    <div class="mb-2">
                                        <span class="badge bg-info" id="previewType">
                                            ${discountCode.discountType == 'PERCENTAGE' ? 'Percentage' : 'Fixed Amount'}
                                        </span>
                                        <span class="ms-2 fw-bold text-success" id="previewValue">
                                            <c:choose>
                                                <c:when test="${discountCode.discountType == 'PERCENTAGE'}">
                                                    ${discountCode.discountValue}%
                                                </c:when>
                                                <c:otherwise>
                                                    <fmt:formatNumber value="${discountCode.discountValue}" type="currency" currencySymbol="₫" groupingUsed="true"/>
                                                </c:otherwise>
                                            </c:choose>
                                        </span>
                                    </div>
                                    <div class="small text-muted mb-2" id="previewConditions">Loading...</div>
                                    <div class="small text-muted" id="previewDuration">Loading...</div>
                                </div>
                            </div>
                            
                            <!-- Warning if code has been used -->
                            <c:if test="${discountCode.usedCount > 0}">
                                <div class="alert alert-warning mt-3">
                                    <h6><i class="fas fa-exclamation-triangle me-1"></i>Important Notice</h6>
                                    <p class="mb-0 small">
                                        This discount code has been used <strong>${discountCode.usedCount}</strong> times. 
                                        Be careful when modifying settings as it may affect existing users.
                                    </p>
                                </div>
                            </c:if>
                        </div>
    ...
    <script>
        ...
        document.getElementById('editForm').addEventListener('submit', function(e) {
            ...
            const usageLimit = document.getElementById('usageLimit').value;
            const usedCount = ${discountCode.usedCount};
            
            if (usageLimit && parseInt(usageLimit) < usedCount) {
                e.preventDefault();
                alert('Usage limit cannot be less than current used count (' + usedCount + ')');
                return false;
            }
        });
    </script>
