<%-- 
    ...
    Created on : Jun 11, 2025, 10:36:31 PM
    Author     : nguyen
--%>
...
<html lang="en">
    <head>
        ...
        <title>Edit Customer | Warehouse System</title>
            ...
            <div class="main">
                ...
                <main class="content">
                    <div class="container-fluid p-0">
                        ...
                        <div class="row mb-3">
                            <div class="col-6">
                                <h1 class="h2 mb-3 fw-bold text-primary">Edit Customer</h1>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="card shadow-sm">
                                    ...
                                    <div class="card-body pt-3">
                                        <form action="${pageContext.request.contextPath}/sale/updateCustomer" method="POST">
                                            ...
                                            <div class="row mb-3 align-items-center">
                                                <div class="col-md-6 mb-3 mb-md-0">
                                                    ...
                                                    <input type="text" class="form-control form-control-lg" id="customerName" name="customerName" 
                                                           value="${customer.customerName}" required maxlength="100">
                                                </div>
                                            </div>
                                            <div class="row mb-3 align-items-center">
                                                <div class="col-md-6 mt-3">
                                                    ...
                                                    <input type="tel" class="form-control form-control-lg" id="phone" name="phone" 
                                                           value="${customer.phone}" required pattern="[0-9]{10}">
                                            ...
                                            <div class="row mb-4">
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea class="form-control" id="address" name="address" rows="4" 
                                                              required maxlength="255">${customer.address}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mt-4">
                                                <div class="col-12 text-end">
                                                    ...
                                                    <button type="submit" class="btn btn-primary btn-lg px-4">
                                                        <i class="align-middle me-1" data-feather="save"></i> Update Customer
                                                    </button>
                                                </div>
                                            </div>
                                        </form>
