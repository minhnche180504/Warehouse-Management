...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" href="<c:url value='/img/icons/icon-48x48.png'/>" />
        <link rel="canonical" href="forms-layouts.html" />
        <title>Create Inventory Transfer | Warehouse System</title>
        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;600&amp;display=swap" rel="stylesheet">
        <link class="js-stylesheet" href="<c:url value='/css/light.css'/>" rel="stylesheet">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" id="destinationWarehouseId" name="destinationWarehouseId" required>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#transferForm').on('submit', function(e) {
                    ...
                    const destId = $('#destinationWarehouseId').val();
            ...
            function loadImportRequestItems(importRequestId) {
                ...
                $.ajax({
                    url: 'get-import-request-details',
                    type: 'GET',
