...
<html lang="vi">
    ...
    <body>
                ...
                <main class="content">
                    <div class="container-fluid p-0">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div>
                                <a href="${pageContext.request.contextPath}/staff/list-stock-check-reports" class="btn btn-secondary">
                        ...
                        <form action="${pageContext.request.contextPath}/staff/manage-stock-check-report" method="POST" id="manageStockCheckForm">
                            ...
                            <div class="mt-3 mb-3 text-center">
                                ...
                                <div class="mt-4">
                                    ...
                                    <c:if test="${isWarehouseStaff && viewAction == 'view'}">
                        ...
                        <c:if test="${(isWarehouseManager || isAdmin) && report.status == 'Approved' && viewAction == 'view'}">
                            <form id="completeForm" action="${pageContext.request.contextPath}/staff/manage-stock-check-report" method="POST" style="display:none;">
                                <input type="hidden" name="reportId" value="${report.reportId}">
                        ...
                        <c:if test="${isWarehouseStaff && report.status == 'Draft' && viewAction == 'view'}">
                            <c:if test="${report.status == 'Draft' && currentUser.userId == report.createdBy}">
                                <form id="deleteForm" action="${pageContext.request.contextPath}/staff/manage-stock-check-report" method="POST" style="display:none;">
                                    <input type="hidden" name="reportId" value="${report.reportId}">
                            ...
                            <div class="modal fade" id="approveModal" tabindex="-1" aria-labelledby="approveModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="${pageContext.request.contextPath}/staff/manage-stock-check-report" method="POST">
                                            <input type="hidden" name="reportId" value="${report.reportId}">
        ...
        <script>
            ...
            let isWarehouseManager = ${isWarehouseManager ? 'true' : 'false'};
            let isWarehouseStaff = ${isWarehouseStaff ? 'true' : 'false'};
            let canEditReport = ${canEditReport ? 'true' : 'false'};
