...
<head>
    ...
    <link class="js-stylesheet" href="${pageContext.request.contextPath}/staff/css/light.css" rel="stylesheet">
    <style>
    ...
    <div class="main">
        ...
        <main class="content">
            <div class="container-fluid p-0">
                ...
                <form action="${pageContext.request.contextPath}/staff/create-stock-check-report" method="POST" id="stockCheckForm">
                    <div class="card">
                    ...
                    <div class="text-center mt-3">
                        ...
                        <a href="${pageContext.request.contextPath}/staff/list-stock-check-reports" class="btn btn-secondary btn-lg">Cancel</a>
                    </div>
                </form>
            </div>
        </main>
