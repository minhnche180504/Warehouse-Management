                            ...
                            <div class="tab-pane fade show active" id="account" role="tabpanel">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form id="profileForm" method="post" action="${pageContext.request.contextPath}/staff/UserProfile">
                                            <div class="row">
                                            ...
                                            <div class="mt-3 d-flex gap-2">
                                                <a href="${pageContext.request.contextPath}/staff/warehouse-staff-dashboard" class="btn btn-secondary">Back</a>
