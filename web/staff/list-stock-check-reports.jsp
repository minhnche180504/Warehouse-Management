                ...
                <main class="content">
                    <div class="container-fluid p-0">
                        <div class="row mb-2 mb-xl-3">
                            ...
                            <div class="col-auto ms-auto text-end mt-n1">
                                <c:if test="${isWarehouseStaff || isWarehouseManager || isAdmin}">
                                    <a href="${pageContext.request.contextPath}/staff/create-stock-check-report" class="btn btn-primary">Create New Report</a>
                                </c:if>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="GET" action="${pageContext.request.contextPath}/staff/list-stock-check-reports">
                                    <div class="row">
                                                ...
                                                <c:forEach var="report" items="${reports}">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <td>
                                                                <a href="${pageContext.request.contextPath}/staff/manage-stock-check-report?action=view&reportId=${report.reportId}" class="btn btn-sm btn-info" title="View">
                                                                <i data-feather="eye"></i>
                                                            </a>

                                                            <%-- Show Edit/Delete only if status is Draft and user is creator --%>
                                                            <c:if test="${isWarehouseStaff && report.status == 'Draft' && currentUser.userId == report.createdBy}">
                                                                <a href="${pageContext.request.contextPath}/staff/manage-stock-check-report?action=edit&reportId=${report.reportId}" class="btn btn-sm btn-warning" title="Edit">
