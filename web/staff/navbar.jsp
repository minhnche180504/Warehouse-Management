    ...
    <div class="navbar-nav align-items-center">
        ...
        <div class="nav-item dropdown me-2">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" style="width: 350px;">
                ...
                <div class="list-group list-group-flush">
                    <!-- Low Stock Alert -->
                    <a href="<c:url value='/staff/inventory-alerts'/>" class="list-group-item list-group-item-action">
                    ...
                    <!-- New Order -->
                    <a href="<c:url value='/staff/view-sales-order-list'/>" class="list-group-item list-group-item-action">
                        <div class="row g-0 align-items-center">
                            <div class="col-2">
                    ...
                    <!-- Import Request -->
                    <a href="<c:url value='/staff/importRequestList'/>" class="list-group-item list-group-item-action">
                        <div class="row g-0 align-items-center">
                            <div class="col-2">
                    ...
                    <!-- Transfer Complete -->
                    <a href="<c:url value='/staff/list-transfer-order'/>" class="list-group-item list-group-item-action">
                        <div class="row g-0 align-items-center">
                            <div class="col-2">
                ...
                <div class="dropdown-menu-footer">
                    <a href="<c:url value='/staff/notifications'/>" class="btn btn-outline-primary btn-sm w-100">
        ...
        <div class="nav-item dropdown me-2">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" style="width: 320px;">
                ...
                <div class="dropdown-menu-footer">
                    <a href="<c:url value='/staff/messages'/>" class="btn btn-outline-primary btn-sm w-100">
                        View All Messages
                    </a>
                </div>
            </div>
...
<!--                <div class="status-indicator bg-success me-1"></div>
        ...
        <div class="nav-item dropdown">
            <a class="user-profile-compact dropdown-toggle" href="#" data-bs-toggle="dropdown">
                <img src="<c:url value='/img/avatars/avatar.jpg'/>" 
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                ...
                <li><a class="dropdown-item" href="<c:url value='/staff/UserProfile'/>">
                    <i data-feather="user" class="align-middle me-2"></i> Profile
                </a></li>
                <li><a class="dropdown-item" href="<c:url value='/staff/changePassword'/>">
                    <i data-feather="lock" class="align-middle me-2"></i> Change Password
                </a></li>
                <li><a class="dropdown-item" href="#">
                    <i data-feather="pie-chart" class="align-middle me-2"></i> Analytics
                </a></li>
                <li><hr class="dropdown-divider"></li>
                <li><a class="dropdown-item" href="#">
                    <i data-feather="settings" class="align-middle me-2"></i> Settings
                </a></li>
                <li><a class="dropdown-item" href="#">
                    <i data-feather="help-circle" class="align-middle me-2"></i> Help Center
                </a></li>
                <li><hr class="dropdown-divider"></li>
