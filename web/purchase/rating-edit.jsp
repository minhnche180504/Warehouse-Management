...
<head>
    ...
    <title>Edit Rating - Admin Dashboard</title>
    <meta name="description" content="Edit Supplier Rating">
                ...
                <div class="container-fluid p-0">
                    <div class="row mb-2 mb-xl-3">
                        <div class="col-auto d-none d-sm-block">
                            <h3><strong>Edit</strong> Rating</h3>
                        </div>
                        <div class="col-auto ms-auto text-end mt-n1">
                            <a href="<c:url value='/purchase/supplier-rating?action=my-ratings'/>" class="btn btn-secondary">Back to My Ratings</a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Edit Your Rating</h5>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form action="<c:url value='/purchase/supplier-rating'/>" method="POST">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="star-rating">
                                                    <input type="radio" name="deliveryScore" value="5" id="delivery5" 
                                                        <c:if test="${deliveryScore eq 5 or rating.deliveryScore eq 5}">checked</c:if>>
                                                    <label for="delivery5">★</label>
                                                    <input type="radio" name="deliveryScore" value="4" id="delivery4" 
                                                        <c:if test="${deliveryScore eq 4 or rating.deliveryScore eq 4}">checked</c:if>>
                                                    <label for="delivery4">★</label>
                                                    <input type="radio" name="deliveryScore" value="3" id="delivery3" 
                                                        <c:if test="${deliveryScore eq 3 or rating.deliveryScore eq 3}">checked</c:if>>
                                                    <label for="delivery3">★</label>
                                                    <input type="radio" name="deliveryScore" value="2" id="delivery2" 
                                                        <c:if test="${deliveryScore eq 2 or rating.deliveryScore eq 2}">checked</c:if>>
                                                    <label for="delivery2">★</label>
                                                    <input type="radio" name="deliveryScore" value="1" id="delivery1" 
                                                        <c:if test="${deliveryScore eq 1 or rating.deliveryScore eq 1}">checked</c:if>>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="star-rating">
                                                    <input type="radio" name="qualityScore" value="5" id="quality5" 
                                                        <c:if test="${qualityScore eq 5 or rating.qualityScore eq 5}">checked</c:if>>
                                                    <label for="quality5">★</label>
                                                    <input type="radio" name="qualityScore" value="4" id="quality4" 
                                                        <c:if test="${qualityScore eq 4 or rating.qualityScore eq 4}">checked</c:if>>
                                                    <label for="quality4">★</label>
                                                    <input type="radio" name="qualityScore" value="3" id="quality3" 
                                                        <c:if test="${qualityScore eq 3 or rating.qualityScore eq 3}">checked</c:if>>
                                                    <label for="quality3">★</label>
                                                    <input type="radio" name="qualityScore" value="2" id="quality2" 
                                                        <c:if test="${qualityScore eq 2 or rating.qualityScore eq 2}">checked</c:if>>
                                                    <label for="quality2">★</label>
                                                    <input type="radio" name="qualityScore" value="1" id="quality1" 
                                                        <c:if test="${qualityScore eq 1 or rating.qualityScore eq 1}">checked</c:if>>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="star-rating">
                                                    <input type="radio" name="serviceScore" value="5" id="service5" 
                                                        <c:if test="${serviceScore eq 5 or rating.serviceScore eq 5}">checked</c:if>>
                                                    <label for="service5">★</label>
                                                    <input type="radio" name="serviceScore" value="4" id="service4" 
                                                        <c:if test="${serviceScore eq 4 or rating.serviceScore eq 4}">checked</c:if>>
                                                    <label for="service4">★</label>
                                                    <input type="radio" name="serviceScore" value="3" id="service3" 
                                                        <c:if test="${serviceScore eq 3 or rating.serviceScore eq 3}">checked</c:if>>
                                                    <label for="service3">★</label>
                                                    <input type="radio" name="serviceScore" value="2" id="service2" 
                                                        <c:if test="${serviceScore eq 2 or rating.serviceScore eq 2}">checked</c:if>>
                                                    <label for="service2">★</label>
                                                    <input type="radio" name="serviceScore" value="1" id="service1" 
                                                        <c:if test="${serviceScore eq 1 or rating.serviceScore eq 1}">checked</c:if>>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="star-rating">
                                                    <input type="radio" name="priceScore" value="5" id="price5" 
                                                        <c:if test="${priceScore eq 5 or rating.priceScore eq 5}">checked</c:if>>
                                                    <label for="price5">★</label>
                                                    <input type="radio" name="priceScore" value="4" id="price4" 
                                                        <c:if test="${priceScore eq 4 or rating.priceScore eq 4}">checked</c:if>>
                                                    <label for="price4">★</label>
                                                    <input type="radio" name="priceScore" value="3" id="price3" 
                                                        <c:if test="${priceScore eq 3 or rating.priceScore eq 3}">checked</c:if>>
                                                    <label for="price3">★</label>
                                                    <input type="radio" name="priceScore" value="2" id="price2" 
                                                        <c:if test="${priceScore eq 2 or rating.priceScore eq 2}">checked</c:if>>
                                                    <label for="price2">★</label>
                                                    <input type="radio" name="priceScore" value="1" id="price1" 
                                                        <c:if test="${priceScore eq 1 or rating.priceScore eq 1}">checked</c:if>>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="comment" name="comment" rows="4" 
                                                placeholder="Share your experience with this supplier...">${comment != null ? comment : rating.comment}</textarea>
                                            <small class="form-text text-muted">Optional feedback about this supplier</small>
                                        </div>

                                        <div class="d-flex justify-content-between">
                                            <a href="<c:url value='/purchase/supplier-rating?action=my-ratings'/>" class="btn btn-secondary">Cancel</a>
