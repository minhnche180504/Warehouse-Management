...
<html lang="en">
    ...
    <body data-theme="default" data-layout="fluid" data-sidebar-position="left" data-sidebar-layout="default">
                            ...
                            <div class="tab-pane fade show active" id="account" role="tabpanel">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form id="profileForm" method="post" action="${pageContext.request.contextPath}/purchase/UserProfile">
                                            <div class="row">
                                            ...
                                            <div class="mt-3 d-flex gap-2">
                                                <a href="${pageContext.request.contextPath}/purchase/purchase-dashboard" class="btn btn-secondary">Back</a>
        ...
        <script src="${pageContext.request.contextPath}/purchase/js/app.js"></script>
        <script>
