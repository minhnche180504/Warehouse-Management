    ...
    <div class="navbar-nav align-items-center">
        ...
        <div class="nav-item dropdown me-2">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" style="width: 350px;">
                ...
                <div class="list-group list-group-flush">
                    <!-- Low Stock Alert -->
                    <a href="<c:url value='/purchase/inventory-alerts'/>" class="list-group-item list-group-item-action">
                    ...
                    <!-- New Order -->
                    <a href="<c:url value='/purchase/view-sales-order-list'/>" class="list-group-item list-group-item-action">
                        <div class="row g-0 align-items-center">
                            <div class="col-2">
                    ...
                    <!-- Import Request -->
                    <a href="<c:url value='/purchase/importRequestList'/>" class="list-group-item list-group-item-action">
                        <div class="row g-0 align-items-center">
                            <div class="col-2">
                    ...
                    <!-- Transfer Complete -->
                    <a href="<c:url value='/purchase/list-transfer-order'/>" class="list-group-item list-group-item-action">
                        <div class="row g-0 align-items-center">
                            <div class="col-2">
                ...
                <div class="dropdown-menu-footer">
                    <a href="<c:url value='/purchase/notifications'/>" class="btn btn-outline-primary btn-sm w-100">
        ...
        <div class="nav-item dropdown me-2">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" style="width: 320px;">
                ...
                <div class="dropdown-menu-footer">
                    <a href="<c:url value='/purchase/messages'/>" class="btn btn-outline-primary btn-sm w-100">
                        View All Messages
                    </a>
                </div>
            </div>
...
<!--                <div class="status-indicator bg-success me-1"></div>
        ...
        <div class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                ...
                <li><a class="dropdown-item" href="<c:url value='/purchase/UserProfile'/>">
                    <i data-feather="user" class="align-middle me-2"></i> Profile
                </a></li>
                <li><a class="dropdown-item" href="<c:url value='/purchase/changePassword'/>">
