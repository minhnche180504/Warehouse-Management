...
<head>
    ...
    <meta name="description" content="Add New Supplier">
                ...
                <div class="container-fluid p-0">
                    <div class="row mb-2 mb-xl-3">
                        <div class="col-auto d-none d-sm-block">
                            <h3><strong>Add New</strong> Supplier</h3>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="<c:url value='/purchase/manage-supplier'/>" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="tel" class="form-control" id="phone" name="phone" 
                                                       value="${phone != null ? phone : ''}" required maxlength="20">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="email" class="form-control" id="email" name="email" 
                                                       value="${email != null ? email : ''}" required maxlength="100">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="address" name="address" rows="3" required maxlength="255">${address != null ? address : ''}</textarea>
                                        ...
                                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                            ...
                                            <button type="submit" class="btn btn-primary">
                                                <i class="align-middle" data-feather="save"></i> Save Supplier
                                            </button>
                                        </div>
                                    </form>
                                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function checkNameExists(name) {
                fetch('${pageContext.request.contextPath}/purchase/manage-supplier?action=check-duplicate&type=name&value=' + encodeURIComponent(name))
            ...
            function checkPhoneExists(phone) {
                ...
                fetch('${pageContext.request.contextPath}/purchase/manage-supplier?action=check-duplicate&type=phone&value=' + encodeURIComponent(digitsOnly))
                    .then(function(response) { return response.json(); })
                    .then(function(data) {
                        if (data.exists) {
            ...
            function checkEmailExists(email) {
                fetch('${pageContext.request.contextPath}/purchase/manage-supplier?action=check-duplicate&type=email&value=' + encodeURIComponent(email))
                    .then(function(response) { return response.json(); })
                    .then(function(data) {
                        if (data.exists) {
