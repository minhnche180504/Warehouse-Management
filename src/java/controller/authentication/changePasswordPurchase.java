 ...
 * @author nguyen
 */
@WebServlet(name="changePasswordPurchase", urlPatterns={"/purchase/changePassword"})
public class changePasswordPurchase extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/purchase/changePassword.jsp").forward(request, response);
    } 
