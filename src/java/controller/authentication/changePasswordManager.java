 ...
 * @author nguyen
 */
@WebServlet(name="changePasswordManager", urlPatterns={"/manager/changePassword"})
public class changePasswordManager extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/manager/changePassword.jsp").forward(request, response);
    } 
