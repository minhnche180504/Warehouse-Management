...
@WebServlet(name = "StaffProfile", urlPatterns = {"/staff/UserProfile"})
public class StaffProfile extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/staff/UserProfile.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (updated) {
                ...
                response.sendRedirect(request.getContextPath()+"/staff/UserProfile?id=" + id);
            } else {
