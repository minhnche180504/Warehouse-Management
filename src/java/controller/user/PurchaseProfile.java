...
@WebServlet(name = "PurchaseProfile", urlPatterns = {"/purchase/UserProfile"})
public class PurchaseProfile extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/purchase/UserProfile.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (updated) {
                ...
                response.sendRedirect(request.getContextPath()+"/purchase/UserProfile?id=" + id);
            } else {
