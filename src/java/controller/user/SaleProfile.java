...
@WebServlet(name = "SaleProfile", urlPatterns = {"/sale/UserProfile"})
public class SaleProfile extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/sale/UserProfile.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (updated) {
                ...
                response.sendRedirect(request.getContextPath()+"/sale/UserProfile?id=" + id);
            } else {
